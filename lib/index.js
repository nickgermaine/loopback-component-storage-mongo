...
(function() {
  ...
  MongoStorage = class MongoStorage {
    ...
    uploadFile(container, file, options, callback = (function() {})) {
      var gfs, stream;
    ...
    __download(file, res, callback = (function() {})) {
      var gfs, read;
      gfs = Grid(this.db, mongodb);
    ...
    downloadById(id, res, callback = (function() {})) {
      var self;
      self = this;
    ...
    download(container, filename, res, callback = (function() {})) {
      var self;
      self = this;
    ...
    __viewFile(file, res, callback = (function() {})) {
      var gfs, read;
      gfs = Grid(this.db, mongodb);
      read = gfs.createReadStream({
        _id: file._id
    ...
    viewFile(container, filename, res, callback = (function() {})) {
      var self;
      self = this;
      return this.getFile(container, filename, function(err, file) {
        if (err) {
