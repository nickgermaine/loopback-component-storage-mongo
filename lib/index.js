...
MongoStorage = (function() {
    ...
    MongoStorage.prototype.__viewFile = function(file, res, callback) {
        var gfs, read;
        if (callback == null) {
            callback = (function() {});
        }
    ...
    MongoStorage.prototype.viewFile = function(container, filename, res, callback) {
        var self;
        if (callback == null) {
            callback = (function() {});
        }
        ...
        return this.getFile(container, filename, function(err, file) {
            ...
            return self.__viewFile(file, res, callback);
        });
    };
...
MongoStorage.prototype.viewFile.http = {
    verb: 'get',
    path: '/:container/view/:file'
};
